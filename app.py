    ...
    with tab3:
        ...
        try:
            ...
            if shap_values is None:
                st.warning("⚠️ SHAP library is not available. This feature requires the SHAP package.")
                st.info("""
                **What is SHAP?**
                SHAP (SHapley Additive exPlanations) provides transparent AI explanations.
                
                **To enable this feature:**
                - Install SHAP: `pip install shap`
                - Or upgrade to Streamlit Cloud Pro for more resources
                
                **For now, you can still see:**
            ...
            st.warning(f"⚠️ Explainability feature temporarily unavailable.")
            st.info("""
            **Alternative Analysis Available:**
            - Check Tab 2 for key approval factors
            - Check Tab 4 for detailed risk breakdown
            - Check Tab 5 for loan recommendations
            """)
